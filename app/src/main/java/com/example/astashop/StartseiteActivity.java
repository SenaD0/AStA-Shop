 ...
 */
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(StartseiteActivity.this, StartseiteActivity.class);
        ...
        qrcode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StartseiteActivity.this, QrcodeActivity.class);
                startActivity(intent);
                finish();
            }
        });
        profilanzeigen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StartseiteActivity.this, ProfilActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        produkthinzu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(StartseiteActivity.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
